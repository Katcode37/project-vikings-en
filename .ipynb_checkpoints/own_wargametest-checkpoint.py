...
while True:
    try:
        ...
        soldier_names = random.sample(viking_names, soldiers_count)
        break
    except:
        print('Odin will not tollarate data type confusion. Enter an intager or pray for yoyr life!')
...
for soldier in soldier_names:
    ...
    new_war.addViking(Viking(soldier, 100, random.randint(1, 100))) # Add a Viking with random strength
