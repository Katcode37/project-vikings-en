...
def run_war(war, number_of_soldiers):
    ...
    print(f'Vikings have dealt total damage of {saxons_total_health - saxons_leftover_health} and killed {number_of_soldiers - len(war.saxonArmy)} saxons')
    print(f'Saxons have dealt total damage of {viking_total_health - vikings_leftover_health} and killed {number_of_soldiers - len(war.vikingArmy)} vikings')
